      ...
      >
        ...
        <View style={styles.carouselSection}>
          {loadingCarousel ? (
            <View style={[styles.carouselLoader, { width: cardWidth }]}>
              ...
              <Text style={styles.loadingText}>{t.home?.loadingCarousel || 'Loading carousel...'}</Text>
            </View>
          ) : (
            <>
              <ScrollView
        ...
        <View style={[styles.sectionContainer, { paddingHorizontal: horizontalPadding }]}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{t.home?.recentEvents || 'Recent Events'}</Text>
            <TouchableOpacity onPress={() => router.push('/events-list')}>
              <Text style={styles.seeAllText}>{t.common?.seeAll || 'View All'}</Text>
            </TouchableOpacity>
          </View>
          ...
          {loadingEvents ? (
            ...
            <View style={styles.emptyStateContainer}>
               ...
               <Text style={styles.emptyStateText}>{t.home?.noEvents || 'No events found'}</Text>
               <Text style={styles.emptyStateSubtext}>{t.home?.createEvent || 'Create your first event!'}</Text>
            </View>
          ) : (
            events.map((event) => {
                  ...
                  {(event.is_cancelled || isPast) && (
                    <View style={[
                      ...
                      <Text style={[
                        ...
                        {event.is_cancelled ? t.home?.cancelled || 'Cancelled' : t.home?.ended || 'Ended'}
                      </Text>
                    </View>
                  )}
        ...
        <View style={[styles.sectionContainer, { paddingHorizontal: horizontalPadding }]}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{t.home?.latestNews || 'Latest Rubber News'}</Text>
          ...
          {updates.length === 0 && !loadingUpdates ? (
            <View style={styles.emptyStateContainer}>
              ...
              <Text style={styles.emptyStateText}>{t.home?.noNews || 'No rubber news available'}</Text>
            </View>
          ) : (
            updates.map((update) => (
              <TouchableOpacity 
                ...
                <View style={styles.updateTextContainer}>
                  ...
                  {update.url && (
                    <View style={styles.readMoreContainer}>
                      <Text style={styles.readMoreText}>{t.common?.readMore || 'Read more'}</Text>
